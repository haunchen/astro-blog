...
![flutter-google-firebase-authentication](./images/img-1.webp)

專案名稱可以隨意取，好辨別的都可以，這邊以「flutter-firebase-test」為專案名稱。取好名稱後，勾選接受條款，即可點擊”繼續”。

![flutter-google-firebase-authentication](./images/img-2.webp)

近期剛好 Google 在 [Google I/O](https://io.google/2025/explore?focus_areas=AI) 上推出一系列的 AI 工具，所以會詢問你是否啟用 Genimi 輔助。

![flutter-google-firebase-authentication](./images/img-3.webp)

接著會詢問你是否開啟 Google Analytics，這裡可以依照 Google 的建議執行。

![flutter-google-firebase-authentication](./images/img-4.webp)

依照指示設定後，便會開始佈建專案，等待大約1~2分鐘後，建立完成。

![flutter-google-firebase-authentication](./images/img-5.webp)

點擊”繼續“後，即會進到專案主畫面。

![flutter-google-firebase-authentication](./images/img-6.webp)

## 新增 Firebase 到應用程式中

根據你的應用程式選擇，這篇以 Flutter 為例，選擇 Flutter 應用程式。

![flutter-google-firebase-authentication](./images/img-7.webp)
...
![flutter-google-firebase-authentication](./images/img-8.webp)
...
![flutter-google-firebase-authentication](./images/img-9.webp)
...
![flutter-google-firebase-authentication](./images/img-10.webp)
...
![flutter-google-firebase-authentication](./images/img-11.webp)

安裝完成後就會看到以下畫面，其中 Firebase Id 屬於敏感資料，請小心不要外流。

![flutter-google-firebase-authentication](./images/img-12.webp)

## 開啟 Firebase Authentication 服務

接著回到 Firebase 專案，找到 Authentication 並開啟該服務。

![flutter-google-firebase-authentication](./images/img-13.webp)

開啟後，會有多種登入方式供你選擇，這邊就以 “Google” 作為範例。勾選開啟 Google 後，需要提供應用程式的指紋，供 Firebase 驗證使用。
...
以上是針對Flutter 串接 Firebase Authentication 方法，也歡迎大家直接下載[原始碼](https://github.com/haunchen/google_signin_example)自行編譯。
